...
const adminChildren: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import("@/pages/admin/knowledge/KnowledgeListPage.vue"),
    meta: { title: "知识库管理", subtitle: "维护知识库、文档和分片内容" }
  },
  {
    path: "knowledge/:kbId",
    name: "admin-knowledge-documents",
    component: () => import("@/pages/admin/knowledge/KnowledgeDocumentsPage.vue"),
    meta: { title: "文档管理", subtitle: "查看知识库文档、解析状态和更新计划" }
  },
  {
    path: "knowledge/:kbId/docs/:docId",
    name: "admin-knowledge-chunks",
    component: () => import("@/pages/admin/knowledge/KnowledgeChunksPage.vue"),
    meta: { title: "分片管理", subtitle: "检查文档分片、向量状态和召回文本" }
  },
  {
    path: "intent-tree",
    name: "admin-intent-tree",
    component: () => import("@/pages/admin/intent-tree/IntentTreePage.vue"),
    meta: { title: "意图树", subtitle: "配置多级意图与问答路由策略" }
  },
  {
    path: "intent-list",
    name: "admin-intent-list",
    component: () => import("@/pages/admin/intent-tree/IntentListPage.vue"),
    meta: { title: "意图列表", subtitle: "维护意图节点、关键词和命中规则" }
  },
  {
    path: "intent-list/:id/edit",
    name: "admin-intent-edit",
    component: () => import("@/pages/admin/intent-tree/IntentEditPage.vue"),
    meta: { title: "编辑意图", subtitle: "调整意图说明、样例问题与召回配置" }
  },
  {
    path: "ingestion",
    name: "admin-ingestion",
    component: () => import("@/pages/admin/ingestion/IngestionPage.vue"),
    meta: { title: "数据接入", subtitle: "跟踪接入流水线、解析节点和失败重试" }
  },
  {
    path: "traces",
    name: "admin-traces",
    component: () => import("@/pages/admin/traces/RagTracePage.vue"),
    meta: { title: "RAG Trace", subtitle: "分析检索、重排、生成和工具调用链路" }
  },
  {
    path: "traces/:traceId",
    name: "admin-trace-detail",
    component: () => import("@/pages/admin/traces/RagTraceDetailPage.vue"),
    meta: { title: "Trace 详情", subtitle: "查看单次问答的完整执行路径" }
  },
  {
    path: "settings",
    name: "admin-settings",
    component: () => import("@/pages/admin/settings/SystemSettingsPage.vue"),
    meta: { title: "系统设置", subtitle: "管理模型、检索、记忆和默认参数" }
  },
  {
    path: "sample-questions",
    name: "admin-sample-questions",
    component: () => import("@/pages/admin/sample-questions/SampleQuestionPage.vue"),
    meta: { title: "样例问题", subtitle: "维护聊天首页推荐问题" }
  },
  {
    path: "mappings",
    name: "admin-mappings",
    component: () => import("@/pages/admin/query-term-mapping/QueryTermMappingPage.vue"),
